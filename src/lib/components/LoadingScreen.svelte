...
{#if !removed}
	...
	<div
		...
		role="img"
	>
		<span class="word top-left"
			><span class="word-pull" style:transform={pullTopLeft}>{text.topLeft}</span></span
		>
		<span class="word top-right"
			><span class="word-pull" style:transform={pullTopRight}>{text.topRight}</span></span
		>
		<span class="word bottom-left"
			><span class="word-pull" style:transform={pullBottomLeft}>{text.bottomLeft}</span></span
		>
		<span class="word bottom-right"
			><span class="word-pull" style:transform={pullBottomRight}>{text.bottomRight}</span></span
		>
		<span class="word center"
			><span class="word-pull" style:transform={pullCenter}>{text.center}</span></span
		>
	</div>
{/if}
